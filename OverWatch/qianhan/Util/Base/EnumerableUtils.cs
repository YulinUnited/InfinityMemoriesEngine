...
namespace InfinityMemoriesEngine.OverWatch.qianhan.Util.Base
{
    ...
    public static partial class EnumerableEx
    {
        ...
        {
            return self.PairChainIndexed(true);
        }
        ...
        {
            return self.Triples(false, false);
        }
        ...
        /// <exception cref="ArgumentNullException">source, selector or greaterThan is null.</exception>
        ...
        /// <exception cref="ArgumentNullException">source, selector or smallerThan is null.</exception>
        ...
        {
            return self.MinIndex((a, b) => a.CompareTo(b) < 0, out minValue);
        }

        public static int MaxIndex<T>(this IEnumerable<T> self, out T minValue)
            where T : IComparable<T>
        {
            return self.MaxIndex((a, b) => a.CompareTo(b) > 0, out minValue);
        }
        ...
        {
            T foo;
            return self.MinIndex((a, b) => a.CompareTo(b) < 0, out foo);
        }
        ...
        {
            T foo;
            return self.MaxIndex((a, b) => a.CompareTo(b) > 0, out foo);
        }
        ...
        public static int MaxIndex<T>(this T[] self, out T maxValue)
            where T : IComparable<T>
        {
            return self.MaxIndex((a, b) => a.CompareTo(b) > 0, out maxValue);
        }
